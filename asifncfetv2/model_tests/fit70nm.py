...
fit1.updateparameter('modelcardpath',rootfolder+'/userjp/asifncfetv2/modelcards/modecard70nm.txt')
...
fit1.updateparameter('modelcardpathfinal',rootfolder+'/userjp/asifncfetv2/modelcards/modecard70nmNFIT1.txt')
