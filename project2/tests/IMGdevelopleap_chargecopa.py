...
sim1.updateparameter('deviceparameter',['L','EOT1','EOT2','PHIG1','PHIG2','TSI','NBG','CBGCBG0','CBGCBG0P','CBGCBG','CBGCBGP','CBGCBGD','CDSC'])
#device parameter values for simulation
sim1.updateparameter('deviceparametervalue',[[50e-9],[2e-9],[10e-9],[4.5],[4.5],[12e-9],[0],[0],[0],[0],[0],[0],[0]])
...
#
#device parameters defined to sweep in simulation
sim1.updateparameter('deviceparameter',['L','EOT1','EOT2','PHIG1','PHIG2','TSI','NBG'])
#device parameter values for simulation
sim1.updateparameter('deviceparametervalue',[[50e-9],[2e-9],[10e-9],[4.5],[4.5],[12e-9],[0]])
#add variables to save  
#sim1.updateparameter('vartosave',['CFGFGI','CBGFGI','CDFGI','CSFGI']) #ok
#sim1.updateparameter('vartosave',['IDS','CDFGI','CDSI','vbgs'])#no ok: CBGSI
#sim1.updateparameter('vartosave',['CDDI','CDFGI','CDSI','CDBGI']) #ok
#sim1.updateparameter('vartosave',['CFGDI','CFGFGI','CFGSI','CFGBGI']) # no ok: CFGDI
#sim1.updateparameter('vartosave',['CBGDI','CBGFGI','CBGSI','CBGBGI']) #no ok: CBGSI
#sim1.updateparameter('vartosave',['QFGI','QBGI','QDI','QSI'])
...
P1.updateparameter('ylogflag',0)
P1.updateparameter('symbol','o')
P1.plotfiledata('/users/jpduarte/research/IMGcore/tcaddata.txt','vgf','chargetca',4)
