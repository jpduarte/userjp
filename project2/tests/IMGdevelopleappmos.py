...
sim1.updateparameter('modelcardpath','/users/jpduarte/BSIM_CM_Matlab/BSIM_model_development_v2/DM_Verilog_Hspice/Models_Verilog/BSIMIMG/benchmark_tests/modelcard2.pmos')
...
sim1.updateparameter('dcbiases',[ np.linspace(-0.05,-1,11), np.linspace(-2,0,100), [0], np.linspace(0,0,1)])
