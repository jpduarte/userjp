...
sim1.updateparameter('simresultfilename','hspicesimauxresult.txt')#ULPLg14nmFE10nmvds04FG
...
sim1.updateparameter('dcbiases',[[0.5],np.linspace(0,0.5,100), [0], [0]])#np.linspace(0,1.0,100)
...
sim1.updateparameter('vartosave',['Ids','qm','vfes','vfed','qms','qmd','idsperum'])#
