...
sim1.updateparameter('deviceparameter',['L','alpha1_P','alpha11_P','t_FE','ECGS'])#,'TFIN','NFIN','NRS','NRD'])#TFIN=15n L=30n NFIN=10 NRS=1 NRD=1
#device parameter values for simulation
sim1.updateparameter('deviceparametervalue',[[30e-9],[-8.4927e+07],[6.1166e+11],[200e-9],[0,0.5e-10,1e-10,2.0e-10]])#,[15e-9],[10],[1],[1]])
