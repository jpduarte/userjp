...
sim1.updateparameter('simresultfilename','hspicesimauxresultFE0nmvd07.txt')#ULPLg14nmFE10nmvds04FG
...
sim1.updateparameter('dcbiases',[[0.7],np.linspace(0,1.0,100), [0], [0]])#np.concatenate((np.linspace(0,1.0,100),np.linspace(1.0,0,100)),axis=0)
...
sim1.updateparameter('deviceparametervalue',[[20e-9],[-32.4927e+08],[24.1166e+12],[0e-9]])#,[15e-9],[10],[1],[1]]) 100e-9,200e-9,300e-9
#add variables to save
sim1.updateparameter('vartosave',['Ids','qm','vfes','qms','qmd','idsperum'])#
