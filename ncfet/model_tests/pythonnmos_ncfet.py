...
sim1.updateparameter('dcbiases',[np.linspace(0.05,0.5,2), np.linspace(0.0,0.5,50), [0], [0]])
...
sim1.updateparameter('deviceparametervalue',[[100e-9],[100e-9]])
...
P1.updateparameter('derivativeorder',0)
P1.updateparameter('lw',2)
P1.plotfiledata(pathandfile,sim1.vartosave[2],sim1.vartosave[1],6)
#plt.savefig('QgvsVFE_example.png', bbox_inches='tight')
#######################################################################
...
P1.updateparameter('lw',5)
P1.plotfiledata(pathandfile,Vx,sim1.vartosave[0],1)
plt.savefig('IdVg_lin.png', bbox_inches='tight')
#plot derivative, 1 indicates derivative order
P1.updateparameter('ylogflag',1)
P1.updateparameter('lw',2)
P1.plotfiledata(pathandfile,Vx,sim1.vartosave[0],2)
plt.savefig('IdVg_log.png', bbox_inches='tight')
P1.updateparameter('ylogflag',0)
P1.updateparameter('lw',2)
P1.plotfiledata(pathandfile,Vx,sim1.vartosave[1],3)
plt.savefig('QgVg_lin.png', bbox_inches='tight')
