...
sim1.updateparameter('dcbiases',[[0.5],np.linspace(0,1.0,50), [0], [0]])#np.concatenate((np.linspace(0,1.0,50),np.linspace(1.0,0,50)),axis=0) 
...
sim1.updateparameter('deviceparametervalue',[[30e-9],[-8.4927e+07],[6.1166e+11],[0,100e-9,200e-9,300e-9]])#,[15e-9],[10],[1],[1]]) 100e-9,200e-9,300e-9
#add variables to save
sim1.updateparameter('vartosave',['Ids','qs','vfes','vfed'])#,'I1aux','I2aux','I3aux','Ib1aux','Ib2aux','Ib3aux','I4aux','Ib4aux'])
