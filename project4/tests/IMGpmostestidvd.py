...
sim1.updateparameter('dcbiases',[  np.arange(-5,5,0.01), np.linspace(-5,-5,1), [0],  np.linspace(-5,5,11)])
...
#sim1.updateparameter('vartosave',['phisatsb','aux6qi','aux5qi','aux1qi','aux2qi','aux3qi','aux4qi','phisolution','phibsnew','phisats','xg1s','xg2s','IDS','qicores','qicoresaux','f1s','df1s','qsqrt1s','qicore1s','qicore2s','qsqrt2s','qsqrt3s','qsqrt4s','qsqrt5s','qsqrt0s','qicored','qicoreguessd','differenceaux','xg1','xg2','phisguesssf','phisguesssb','phifsnew'])#no ok: CBGSI ,'phifdnew','vbgs'
sim1.updateparameter('vartosave',['IDS'])
...
P1.plotfiledata(pathandfile,Vx,'phisats',8)

P1.updateparameter('ylogflag',0)
P1.updateparameter('symbol','s')
P1.updateparameter('color','r')
P1.plotfiledata(pathandfile,Vx,'phisatsb',8)


P1.updateparameter('ylogflag',0)
P1.updateparameter('symbol','-')
P1.updateparameter('color','r')
P1.plotfiledata(pathandfile,Vx,'xg1s',9)

P1.updateparameter('ylogflag',0)
P1.updateparameter('symbol','--')
P1.updateparameter('color','r')
P1.plotfiledata(pathandfile,Vx,'xg2s',9)


P1.updateparameter('ylogflag',0)
P1.updateparameter('symbol','-')
P1.updateparameter('color','k')
P1.plotfiledata(pathandfile,Vx,'xg1',9)

P1.updateparameter('ylogflag',0)
P1.updateparameter('symbol','--')
P1.updateparameter('color','k')
P1.plotfiledata(pathandfile,Vx,'xg2',9)
"""
plt.show()
