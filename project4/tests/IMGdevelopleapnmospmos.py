...
sim1.updateparameter('modelcardpath','/users/jpduarte/BSIM_CM_Matlab/BSIM_model_development_v2/DM_Verilog_Hspice/Models_Verilog/BSIMIMG/benchmark_tests/modelcard.pmos')
...
sim1.updateparameter('dcbiases',[ np.linspace(-0.05,-1,11), np.linspace(-1,0,30), [0], np.linspace(0,0,1)])
...
sim1.updateparameter('deviceparametervalue',[[50e-9]])
...
sim1.updateparameter('dcbiases',[ np.linspace(0.05,1,11), np.linspace(0,1,30), [0], [0]])
###########################################################################
##################Simulation Excecution####################################
###########################################################################
sim1.runsim()
