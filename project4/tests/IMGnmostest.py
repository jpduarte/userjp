...
sim1.updateparameter('dcbiases',[ np.linspace(1,1,1), np.arange(-1.5,1.5,0.02), [0],  np.linspace(5,-5,21)])
...
sim1.updateparameter('vartosave',['IDS','qicore','xg1','xg2'])#no ok: CBGSI ,'phifdnew','vbgs'
