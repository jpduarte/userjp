...
sim1.updateparameter('dcbiases',[ np.linspace(-1.5,1.5,101), np.linspace(-1.5,1.5,10), [0],  np.linspace(0,0,1)])
...
sim1.updateparameter('vartosave',['IDS','qicoredelta','xg1','phifsnew'])#no ok: CBGSI ,'phifdnew','vbgs'
