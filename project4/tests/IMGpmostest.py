...
sim1.updateparameter('modelcardpath',rootfolder+'/userjp/project4/modelcards/modelcardsimple.pmos')
...
sim1.updateparameter('dcbiases',[ np.linspace(-0.1,-0.1,1), np.arange(-1.5,1.5,0.02), [0],  np.linspace(-5,5,21)])
...
sim1.updateparameter('deviceparametervalue',[[55e-9]]) #TODO: fix parameter sweep, it is not working, seems it must be declare in the device part
#add variables to save
sim1.updateparameter('vartosave',['IDS','phi1','xg1','xg1min'])#no ok: CBGSI ,'phifdnew','vbgs'
