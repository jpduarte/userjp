...
sim1.updateparameter('modelcardpath',rootfolder+'/userjp/project5/modelcards/modelcard.nmos')
#add path to folder which will contain simulation files
sim1.updateparameter('simulationfolder',rootfolder+'/userjp/project5/hspicesimulations/idvg/')
