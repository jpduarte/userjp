...
sim1.updateparameter('modelcardpath',rootfolder+'/userjp/project1/modelcards/modecardufcm.txt')
#add path to folder which will contain simulation files
sim1.updateparameter('simulationfolder',rootfolder+'/userjp/project1/pythonsimulations/idvg/')
