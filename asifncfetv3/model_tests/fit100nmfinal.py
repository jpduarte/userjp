#Fitting for 100nm pmos FET, sematech
...
fit1.updateparameter('modelcardpath',rootfolder+'/userjp/asifncfetv3/modelcards/modecard100nmNFIT2.txt')
#add path to folder which will contain simulation files
fit1.updateparameter('fitfolder',rootfolder+'/userjp/asifncfetv3/fitdata/')
...
fit1.updateparameter('simulationresultsfilename','simulation100nm.txt')
...
fit1.resetdata()
pathallfiles = '/home/juan/research/userjp/asifncfetv3/data/100nm/'
...
fit1.updateparameter('modelcardpathfinal',rootfolder+'/userjp/asifncfetv3/modelcards/modecard100nmNFIT2.txt')
