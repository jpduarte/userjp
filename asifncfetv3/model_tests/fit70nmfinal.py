...
fit1.updateparameter('modelcardpath',rootfolder+'/userjp/asifncfetv2/modelcards/modecard70nmNFIT1.txt')
...
fit1.updateparameter('alldatafile','alldatatofit70nm.txt')
...
fit1.updateparameter('simulationresultsfilename','simulation70nm.txt')
...
fit1.resetdata()
pathallfiles = '/home/juan/research/userjp/asifncfetv2/data/70nm/'
fit1.addalldatainfolder(pathallfiles, ['VS','VB','Lg'], ['0.0','0.0','70e-9'])
...
fit1.updateparameter('modelcardpathfinal',rootfolder+'/userjp/asifncfetv2/modelcards/modecard70nmNFIT2.txt')
